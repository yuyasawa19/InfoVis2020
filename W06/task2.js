function main()
{
    ...
    for ( var i = 0; i < 256; i++ )
    {
        ...
        var R = 1.0
        var G = Math.max( 0.5 * ( Math.cos( S * Math.PI ) + 1.0 ), 0.0 );
        var B = Math.max( 0.5 * ( Math.cos( S * Math.PI ) + 1.0 ), 0.0 );
    ...
    {
        var id = faces[i];
        var S0 = Math.round(255 * (scalars[ id[0] ] - min) / (max - min));
        var S1 = Math.round(255 * (scalars[ id[1] ] - min) / (max - min));
        var S2 = Math.round(255 * (scalars[ id[2] ] - min) / (max - min));
